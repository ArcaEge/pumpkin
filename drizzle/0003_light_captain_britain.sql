...
CREATE TABLE `__new_project` (
	...
	`created_at` integer DEFAULT '"2025-11-01T02:20:35.651Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-11-01T02:20:35.651Z"' NOT NULL,
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2025-11-01T02:20:35.650Z"' NOT NULL,
	`last_login_at` integer DEFAULT '"2025-11-01T02:20:35.650Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX `user_slack_id_unique` ON `user` (`slack_id`);--> statement-breakpoint
ALTER TABLE `devlog` ADD `image` text NOT NULL;--> statement-breakpoint
ALTER TABLE `devlog` ADD `model` text;